...
export default function Card({ title, subtitle, avatarText, href, children, childrenPosition = "right" }: CardProps) {
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        ...
        {subtitle && (
          <p className="truncate text-left text-sm text-muted-foreground hover:text-foreground hover:underline">{subtitle}</p>
        )}
      </div>
      ...
      {children && childrenPosition === "right" ? (
        ...
        href && <MoveRight className="shrink-0 text-muted-foreground" />
      )}
